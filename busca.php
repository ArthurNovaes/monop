...
<body>
	<div class="container">
		...
		?>
		<legend><h1>Busca</h1></legend>
		<?php
			if(isset($_GET['search']) && ($_GET['search'] == 101239410000.00 || $_GET['search'] == 3828000.00)){
				$search = $_GET['search'];
			}
			else{
				echo "<br><h1><span class='alert alert-warning'>Não Há Dados para esta Situação</span></h1><br><br>";
				include "footer.html";
				exit;
			}
			...
			while($i<count($result))
			{
				...
				if($search==$investimento_total)
				{
					?>
					<fieldset><legend style="width:30%"; align="center"> 
						<?php echo $dsc_titulo; ?> </legend>
					...
					<div class="well" align="center">
						...
						<div class="row">
							...
							<div class = "col-md-5">
								<?php echo "R$ ".number_format($investimento_total,2,",","."); ?>
